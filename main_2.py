...
with open("epsilon2.txt", "w+") as file:
    pass
...
###############################################################################
# thread body for learning process 2 (exploration rate = epsilon2)
###############################################################################
def learningProcess_2():
    ...
    for it in range(iterations):
        ...
        with open("epsilon2.txt", "a+") as file:
            file.write("iteration {}\n".format(it + 1))
        
        # print("learning process 2 iteration:", it + 1)
        
        # collect trajectories
        dec_pomdp.collect_episodes(var.episode, var.T, epsilon2[it], delta, mu, phi, sigma, lambda_)
        ...
        io.savemat("learning_2.mat", values)
...
###############################################################################
# create threads
RL_thread_2 = threading.Thread(target = learningProcess_2)
