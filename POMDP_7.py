...
class POMDP(object):
            ...
            # in transmission phase
                ...
                if self.agents[index, 3] > 0:
                    ...
                    if self.agents[index, 3] >= self.agents[index, 4]:
                        ...
                        # channel has been occupied by some others
                        if np.random.default_rng().binomial(1, 0.5):
                            
                            # set transmission time 0
                            self.agents[index, 4] = 0
    ...
    def assign_action(self, n, action_index):
        ...
        # set agent idle, no sensing time (= 0)
        else:
            sensing_time = 0
        ...
        # total transmission time for start indicator
